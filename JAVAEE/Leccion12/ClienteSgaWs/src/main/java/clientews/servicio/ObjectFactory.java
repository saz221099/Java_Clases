...
public class ObjectFactory {
    ...
    private final static QName _Persona_QNAME = new QName("http://servicio.sga.gm.com.mx/", "persona");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.gm.com.mx/", name = "persona")
